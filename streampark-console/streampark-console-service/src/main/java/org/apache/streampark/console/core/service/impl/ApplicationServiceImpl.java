...
public class ApplicationServiceImpl extends ServiceImpl<ApplicationMapper, Application>
  ...
  @Override
    ...
    public void cancel(Application appParam) throws Exception {
        ...
        application.setState(FlinkAppState.CANCELLING.getValue());ApplicationLog applicationLog = new ApplicationLog();
    ...
    applicationLog.setYarnAppId(application.getClusterId());
        ...
        CompletableFutureUtils.runTimeout(
                ...
                TimeUnit.MINUTES,
                cancelResponse -> {
                    applicationLog.setSuccess(true);if (cancelResponse != null && cancelResponse.savePointDir() != null) {
            ...
            .whenComplete(
                (t, e) -> {
                    ...
                    cancelFutureMap.remove(application.getId());applicationLogService.save(applicationLog);
                });
    }
     ...
     */
    @Override
    public void starting(Application
            application) {
