...
public class SqlWorkBenchController {
  ...
  public RestResponse openSession(FlinkCluster cluster, String serviceType) {
    SessionHandle sessionHandle = sqlWorkBenchService.openSession(cluster, serviceType);
